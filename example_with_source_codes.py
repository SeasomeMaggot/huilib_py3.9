...
class TestDialog(HDialog):
    def __init__(self, name, title):
        ...
        rowL = HRowLayout()
        slidersLayout = HColumnLayout()
        buttonLayout = HColumnLayout()
        ...
        self.chkBTN1 = HButton('check_btn1', 'Check 1')
        self.chkBTN1.setAttributes(vstretch = True)
        self.chkBTN2 = HButton('check_btn2', 'Check 2')
        ...
        self.btn1 = HButton('btn1','List Nodes')
        self.btn2 = HButton('btn2','Rand Color')
        self.btn3 = HButton('btn3','Button 3')

        rowLayout = HRowLayout()
        ...
        # Close Button
        self.closeBTN = HButton('close', 'Close')
